...
export function Navbar({
  ...
  return (
    <>
      {/* Scrolls away with the page (not sticky) -- only the main bar below stays pinned. */}
      <div className="hidden bg-dark sm:block">
        <div className="mx-auto flex h-8 max-w-[1180px] items-center justify-between px-5 text-[12px] text-on-dark-mut sm:px-8">
          <span>{strapline}</span>
